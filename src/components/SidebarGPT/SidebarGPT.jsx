...
const SidebarGPT = () => {
    ...
    return (
        <div ref={sidebarRef} className={`sidebar-gpt ${openSidebar ? "open" : ""}`}>
            <div className="top-gpt">
                ...
                <div className="new-chat-gpt" onClick={() => { newChat(); setOpenSidebar(false); }}>
            ...
            <div className="bottom-gpt">
                {/* ✅ Fix: chat.id no existe en este scope */}
