...
const TEXT_EXTENSIONS = new Set('txt md markdown csv tsv json js jsx ts tsx py css html htm xml yaml yml sql sh c cpp h hpp java rs go rb php log toml ini'.split(' '));
...
export function validateFile(file) {
  ...
  if (file.name.length > 200) throw new Error('Use a filename of 200 characters or less.');
